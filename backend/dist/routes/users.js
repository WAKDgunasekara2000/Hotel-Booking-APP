...
router.post("/register", [
    ...
    (0, express_validator_1.check)("password", "Password with 6 or more characters is required").isLength({
        min: 6,
    }),
    ...
    try {
        ...
        console.log(error);
        res.status(500).send({ message: "Semething went Wrong" });
    }
}));
